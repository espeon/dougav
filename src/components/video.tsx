...
export default function VideoThumb({
  ...
  return (
    <div className="relative group overflow-hidden rounded-lg max-w-md shadow-lg dark:shadow-slate-950 dark:hover:shadow-rose-950 hover:shadow-xl duration-500 transition-all">
      ...
      <div className="text-left grid gap-1.5 p-4 group-hover:dark:text-gray-900 group-hover:dark:bg-gray-800 duration-100 transition-colors">
        <h3 className="font-semibold text-base/none group-hover:text-gray-900 dark:group-hover:text-gray-50 duration-100 transition-colors">
          {name}
        </h3>
      </div>
    </div>
